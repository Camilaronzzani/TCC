    ...
    <div class="container mx-auto px-6 py-10">
        <div class="flex flex-col lg:flex-row items-center justify-between bg-white rounded-xl shadow-xl overflow-hidden">
            ...
            <div class="w-full lg:w-1/2 bg-gray-100 p-10 rounded-lg lg:rounded-r-xl shadow-md">
                ...
                <form id="agendamento-form" method="POST" action="{{ route('cadastrar_gerenciamento') }}" class="space-y-4">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <x-input name="endereco" id="endereco" required placeholder="Endereço" />
                            <x-input-error :messages="$errors->get('endereco')" class="mt-2" />
                        </div>
                        <div>
                            <x-input name="cidade" id="cidade" required placeholder="Cidade" />
